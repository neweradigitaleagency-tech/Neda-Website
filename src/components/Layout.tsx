...
<Link to="/" className="flex items-center gap-2 mb-4">
              ...
              <div className="flex gap-3">
                ...
                <a href="https://www.tiktok.com/@neweradigitaleagency" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-gray-100 flex items-center justify-center text-[#EE1D52] hover:bg-[#EE1D52] hover:text-white transition-all">
